...
function changetext() {
  ...
  if (text.textContent.match("A UX Figma design project, weLearn is a mobile studying app created by myself & Carter V.")) {
    text.textContent = "A mockup Playstation 5 video game cover of a basketball game."
  } else {
    text.textContent = "A UX Figma design project, weLearn is a mobile studying app created by myself & Carter V."
  }
} 
